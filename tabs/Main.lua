...
function setup()
    ...
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "dragon.json", "dragon.atlas"))
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "alien.json", "alien.atlas"))
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "powerup.json", "powerup.atlas"))
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "speedy.json", "speedy.atlas"))
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "tank.json", "tank.atlas"))
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "hero.json", "hero.atlas"))
    table.insert(actors, spine.Actor(lfs.DROPBOX.."/spine-data", "vine.json", "vine.atlas"))

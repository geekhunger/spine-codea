...
function spine.Actor:setScale(new_scale_x, new_scale_y)
    ...
    -- NOTE: Scale skeleton by scaling Codea's view matrix
    -- or use spines method by scaling the root bone of the skeleton:
    --[[
        local root_bone = self.skeleton:findBone("root")
